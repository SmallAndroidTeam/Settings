...
//                           OnColorChangedListener listener, AttributeSet attrs) {
//        super(context,initialColor,listener,attrs);
//
//
//        initAttr(context,attrs);
//        init(context);
...
//    }
    ...
    public void init(Context context, int height, int width){
        ...
        //默认画笔为实心，所以不要设置圆环的宽度
//            mCenterPaint.setStrokeWidth(50);
...
//                        ColorPickerDialog.this.dismiss();
     ...
     * @return
     */
    private boolean inCenter(float x, float y, float centerRadius,int screen) {
